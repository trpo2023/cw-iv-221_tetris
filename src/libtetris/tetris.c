...
int menu()
{
    ...
    printf("█████████████████░░░░░░░░░██████\n");
    printf("█████████████████░░░░░░░░░██████\n");
    printf("█████████████████░░░░░░░░░██████\t\t-Добро пожаловать в тетрис! Ваша жизнь очень скучна если вы в это играете\t\n");
    printf("░░░░░░░░░░░░░░░░░░░░░░░░░░██████\t\t- Используйте клавиши W A S D для управления положением и скоротью фигур\t\n");
    printf("▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄░░░░░░░░░██████\t\t-   Используйте клавишу Q - для выхода или P - для приостановки игры\t\n");
    printf("█████████████████░░░░░░░░░░░░░░░\t\t-    Что бы начать увлекательное приключение нажмите любую кнопку\t\n");
    printf("█████████████████░░░▄▄▄▄▄▄░░░░░░\n");
    printf("▀▀▀▀▀▀▀▀▀▀▀██████░░░██████░░░░░░\n");
    printf("▄▄▄▄▄▄▄▄▄░░██████░░░██████░░░░░░\n");
    printf("█████████░░░░░░░░░░░██████░░░░░░\n");
...
int lineTetris(Game* tetGame) // удаляет заполнненые строки
{
    ...
    for (int i = tfl->height - 1; i >= 0; i--) {
        while (lineFilled(i, tfl)) {
            ...
            if (tetGame->ticks > 10) {
                tetGame->ticks -= 5;
                tetGame->ticksLeft = tetGame->ticks;
            }
            count++;
        }
    }
